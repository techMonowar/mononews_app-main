...
import 'package:mononews_app/data/repositories/article_repository_impl.dart';
...
void main() {
  ...
  group('Now Playing Articles', () {
    ...
    group('when device is online', () {
      ...
      test(
        ...
        verify(mockRemoteDataSource.getTopHeadlineArticles());
        verify(
            mockLocalDataSource.cacheTopHeadlineArticles([testArticleCache]));
      });
    ...
    group('when device is online', () {
      ...
      test(
        ...
        verify(mockLocalDataSource
            .cacheHeadlineBusinessArticles([testArticleCache]));
      });
  ...
  group('Search Articles', () {
    ...
    test('should return Article list when call to data source is successful',
      ...
      /* workaround to test List in Right. Issue: https://github.com/spebbe/dartz/issues/80 */
      final resultList =
          result.getOrElse(() => Articles(totalResults: 1, articles: []));
