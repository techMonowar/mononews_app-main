...
import 'package:mononews_app/domain/usecases/get_bookmark_status.dart';
import 'package:mononews_app/domain/usecases/remove_bookmark_article.dart';
import 'package:mononews_app/domain/usecases/save_bookmark_article.dart';
import 'package:mononews_app/presentation/bloc/article_detail_bloc/article_detail_bloc.dart';
...
void main() {
    ...
    blocTest<ArticleDetailBloc, ArticleDetailState>(
      ...
      expect: () => [
        ...
        ArticleDetailStateInit.copyWith(
            bookmarkMessage: 'Added to Bookmark', isAddedToBookmark: true),
      ],
      verify: (_) {
  ...
  group('Remove From Bookmark Article', () {
    blocTest<ArticleDetailBloc, ArticleDetailState>(
      ...
      expect: () => [
        ArticleDetailStateInit.copyWith(
            bookmarkMessage: 'Removed From Bookmark', isAddedToBookmark: false),
      ],
      verify: (_) {
  ...
  group('LoadBookmarkStatus', () {
    blocTest<ArticleDetailBloc, ArticleDetailState>(
      ...
      expect: () => [
        ArticleDetailStateInit.copyWith(isAddedToBookmark: true),
      ],
      verify: (_) {
        verify(mockGetBookmarkStatus.execute(tArticle.url));
      },
